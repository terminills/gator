...
class SetupConfigRequest(BaseModel):
    ...
    ai_model_path: Optional[str] = Field(None, description="Path to AI models directory")
    ...
    stable_diffusion_model: Optional[str] = Field(None, description="Stable Diffusion model name")
    content_moderation_model: Optional[str] = Field(None, description="Content moderation model")
    ...
    instagram_api_secret: Optional[str] = Field(None, description="Instagram API secret")
    ...
    jwt_expiration_hours: Optional[int] = Field(None, description="JWT expiration in hours")
    ...
    max_content_generation_concurrent: Optional[int] = Field(None, description="Max concurrent generations")
    content_cache_ttl_seconds: Optional[int] = Field(None, description="Content cache TTL")
    
    # File Storage
    upload_path: Optional[str] = Field(None, description="Upload directory path")
    generated_content_path: Optional[str] = Field(None, description="Generated content path")
    ...
    nsfw_threshold: Optional[float] = Field(None, description="NSFW detection threshold")
    bias_threshold: Optional[float] = Field(None, description="Bias detection threshold")
    ...
    facebook_webhook_verify_token: Optional[str] = Field(None, description="Facebook webhook token")
    instagram_webhook_verify_token: Optional[str] = Field(None, description="Instagram webhook token")
...
async def update_configuration(
    ...
    try:
        ...
        if success:
            logger.info(f"Configuration updated successfully with {len(config_dict)} values")
    ...
    template = {
        "sections": {
            ...
            "social_media": {
                ...
                "fields": {
                    "FACEBOOK_API_KEY": {"label": "Facebook API Key", "type": "password"},
                    "FACEBOOK_API_SECRET": {"label": "Facebook API Secret", "type": "password"},
                    "INSTAGRAM_API_KEY": {"label": "Instagram API Key", "type": "password"},
                    "INSTAGRAM_API_SECRET": {"label": "Instagram API Secret", "type": "password"},
                    "TWITTER_API_KEY": {"label": "Twitter API Key", "type": "password"},
                    "TWITTER_API_SECRET": {"label": "Twitter API Secret", "type": "password"}
                }
            },
            "dns": {
                ...
                "fields": {
                    ...
                    "GODADDY_API_SECRET": {"label": "GoDaddy API Secret", "type": "password"},
                    "GODADDY_ENVIRONMENT": {"label": "GoDaddy Environment", "type": "text", "default": "production"},
            ...
            "application": {
                ...
                "fields": {
                    "DEBUG": {"label": "Debug Mode", "type": "boolean", "default": "true"},
                    "ENVIRONMENT": {"label": "Environment", "type": "text", "default": "development"},
                    "LOG_LEVEL": {"label": "Log Level", "type": "text", "default": "DEBUG"}
                }
            }
        }
    }
