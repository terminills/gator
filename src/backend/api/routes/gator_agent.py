...
class ChatMessage(BaseModel):
    ...
    context: Optional[Dict] = Field(None, description="Optional context about current page/state")
...
async def get_quick_help_topics():
    ...
    try:
        ...
        raise HTTPException(
            status_code=500,
            detail=f"Error getting help topics: {str(e)}"
        )
...
async def get_agent_status():
    ...
    try:
        ...
        return {
            ...
            "available_topics": [
                "Personas", "Content Generation", "DNS Management",
                "System Status", "GoDaddy Integration", "Troubleshooting"
            ]
        }
