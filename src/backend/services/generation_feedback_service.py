...
class GenerationFeedbackService:
    ...
    async def record_benchmark(
        self, 
        benchmark_data: GenerationBenchmarkCreate
    ) -> GenerationBenchmarkResponse:
        """
    ...
    async def get_benchmark_stats(
        ...
        try:
            ...
            return BenchmarkStats(
                ...
                avg_quality_score=total_quality / quality_count if quality_count > 0 else None,
    ...
    async def get_prompt_enhancement_insights(
        ...
        try:
            ...
            rating_threshold = ["excellent", "good"] if min_rating == "good" else ["excellent"]
