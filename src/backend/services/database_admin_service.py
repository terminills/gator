...
class DatabaseAdminService:
                ...
                for backup_file in self.backup_dir.glob(pattern):
                    if backup_file.is_file():
                        ...
                        backups.append({
                            ...
                            "type": "sqlite" if backup_file.suffix == ".db" else "postgresql"
                        })
    ...
    async def sync_schema(self) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                "extra_tables_warning": status["extra_tables"] if status["extra_tables"] else None,
    ...
    async def get_database_info(self) -> Dict[str, Any]:
        ...
        try:
            ...
            info = {
                "success": True,
                "database_url": self.db_url.split("@")[0].split("//")[0] + "//***",  # Hide credentials
