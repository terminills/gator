...
from backend.services.social_media_service import SocialAccount, PostResponse, PostStatus, PlatformType
...
class InstagramClient(PlatformClientBase):
    ...
    async def validate_credentials(self, account: SocialAccount) -> bool:
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                logger.info(f"Instagram credentials validated for user: {user_data.get('username')}")
                return True
            else:
                logger.warning(f"Instagram credential validation failed: {response.status_code}")
                return False
    ...
    async def publish_content(self, account: SocialAccount, content_data: Dict[str, Any]) -> PostResponse:
        ...
        try:
            ...
            if content_type == "image":
                ...
                raise ValueError(f"Unsupported content type for Instagram: {content_type}")
    ...
    async def _publish_image(self, account: SocialAccount, content_data: Dict[str, Any]) -> PostResponse:
    ...
    async def get_engagement_metrics(self, account: SocialAccount, post_id: str) -> Dict[str, int]:
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                logger.warning(f"Instagram metrics retrieval failed: {response.status_code}")
                return {}
...
class FacebookClient(PlatformClientBase):
    ...
    async def publish_content(self, account: SocialAccount, content_data: Dict[str, Any]) -> PostResponse:
        ...
        try:
            ...
            if content_type in ["text", "image"]:
                ...
                raise ValueError(f"Unsupported content type for Facebook: {content_type}")
    ...
    async def _publish_post(self, account: SocialAccount, content_data: Dict[str, Any]) -> PostResponse:
        ...
        try:
            ...
            response = await self.http_client.post(
                f"{self.base_url}/{account.account_id}/feed",
                data=post_data
            )
...
class TwitterClient(PlatformClientBase):
    ...
    async def publish_content(self, account: SocialAccount, content_data: Dict[str, Any]) -> PostResponse:
        ...
        try:
            ...
            if content_type == "text":
                ...
                raise ValueError(f"Unsupported content type for Twitter: {content_type}")
    ...
    async def _publish_tweet(self, account: SocialAccount, content_data: Dict[str, Any]) -> PostResponse:
...
class LinkedInClient(PlatformClientBase):
    ...
    async def publish_content(self, account: SocialAccount, content_data: Dict[str, Any]) -> PostResponse:
        ...
        try:
            ...
            if content_type == "text":
                ...
                raise ValueError(f"Unsupported content type for LinkedIn: {content_type}")
    ...
    async def _publish_post(self, account: SocialAccount, content_data: Dict[str, Any]) -> PostResponse:
        ...
        try:
            ...
            # LinkedIn doesn't return the post ID in the same way
            # You'd need to parse the response headers for the ID
            post_id = "linkedin_post_id"  # Placeholder
