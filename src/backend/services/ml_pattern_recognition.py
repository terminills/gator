...
from backend.models.acd import ACDContextModel, AIStatus, AIState
...
class MLPatternRecognitionService:
    ...
    async def extract_features(
        ...
        try:
            ...
            state_map = {
                ...
                "BLOCKED": 4, "FAILED": 5, "CANCELLED": 6
            }
            ...
            # Confidence encoding
            confidence_map = {
                "CONFIDENT": 4, "VALIDATED": 5, "UNCERTAIN": 2,
                "HYPOTHESIS": 1, "EXPERIMENTAL": 1
            }
            ...
            # Validation features
            validation_map = {
                "APPROVED": 5, "CONDITIONALLY_APPROVED": 3,
                "REJECTED": 1, "PENDING": 2, "ANALYZED": 4
            }
        ...
        try:
            ...
            if self.engagement_model:
                joblib.dump(
                    ...
                    f"{path_prefix}/engagement_model.joblib"
                )
            
            if self.success_classifier:
                joblib.dump(
                    self.success_classifier,
                    f"{path_prefix}/success_classifier.joblib"
                )
    ...
    async def analyze_feature_importance(self) -> Optional[Dict[str, Any]]:
        ...
        try:
            feature_names = [
                "hour_of_day", "day_of_week", "complexity", "state",
                "confidence", "engagement_rate", "genuine_users_log",
                "bots_filtered_log", "prompt_length_log", "has_hashtags",
                "num_hashtags", "has_assignment", "has_handoff",
                "validation", "is_image", "is_text", "is_social", "is_video"
            ]
