...
class PredictiveEngagementScoringService:
        ...
        try:
            ...
            if engagement_pred and success_pred:
                ...
                overall_confidence = "high" if (
                    eng_confidence == "high" and succ_confidence == "high"
                ) else "medium"
    ...
    async def optimize_content(
        ...
        try:
            ...
            if not any(word in prompt.lower() for word in ["comment", "share", "like", "follow", "tag"]):
                recommendations.append({
                    "type": "cta",
                    "priority": "medium",
            ...
            potential_improvement = sum([
                15 if r["priority"] == "high" else 8 if r["priority"] == "medium" else 3
                for r in recommendations
            ])
            
            potential_score = min(100, current_score["composite_score"] + potential_improvement)
    ...
    async def suggest_ab_test(
        ...
        try:
            ...
            optimized_hashtags = current_hashtags[:8] if len(current_hashtags) > 8 else current_hashtags + ["trending", "viral"]
    ...
    async def predict_optimal_posting_time(
        ...
        try:
            ...
            for context in contexts:
                ...
                if social_metrics.get("platform") and social_metrics["platform"] != platform:
                    continue
            ...
            hour_averages = {
                ...
                for hour in hour_engagement if hour_counts[hour] > 0
            }
            ...
            return {
                ...
                "best_hour_engagement": float(sorted_hours[0][1]) if sorted_hours else 0.0,
