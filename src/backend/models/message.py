...
from sqlalchemy import Column, String, DateTime, Boolean, ForeignKey, Text, JSON, Integer, Enum as SQLEnum
...
class MessageModel(Base):
    ...
    media_urls = Column(JSON, nullable=True, default=list)  # URLs for images, videos, etc.
    message_metadata = Column(JSON, nullable=True, default=dict)  # Additional message metadata
...
class MessageCreate(BaseModel):
    ...
    message_metadata: Optional[Dict[str, Any]] = Field(default={}, description="Additional metadata")
