...
from sqlalchemy import Column, String, DateTime, Boolean, ForeignKey, Text, JSON, Integer, Float, Enum as SQLEnum
...
class ContentCreate(BaseModel):
    ...
    content_rating: ContentRating = Field(default=ContentRating.SFW, description="Content rating")
    generation_params: Optional[Dict[str, Any]] = Field(default={}, description="Generation parameters")
    target_platforms: Optional[List[str]] = Field(default=[], description="Target platforms")
